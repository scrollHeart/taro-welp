<template>
  ...
  <nut-swiper :init-page="state.page" ref="swiper">
    <nut-swiper-item>
        <div>
            <image height="300px" mode="heightFix" src="@/pages/guides/images/img_guide1.png" />
            <p>
    ...
    <nut-swiper-item>
        <div>
            <image height="300px" mode="heightFix" src="@/pages/guides/images/img_guide2.png" />
            <p>
    ...
    <nut-swiper-item>
        <div>
            <image height="300px" mode="heightFix" src="@/pages/guides/images/img_guide3.png" />
            <p>
